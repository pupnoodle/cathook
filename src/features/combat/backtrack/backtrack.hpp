...
[[nodiscard]] float real_latency_seconds();
[[nodiscard]] float ping_yaw_delta(Player* player);
...
[[nodiscard]] bool command_tick_for_melee_pose(float simulation_time, int extra_ticks, int* tick_count);
