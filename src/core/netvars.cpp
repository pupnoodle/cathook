...
void NetVars::Init()
{
    ...
    IF_GAME(IsTF())
    {
        ...
        this->flLastCritCheckTime           = gNetvars.get_offset("DT_TFWeaponBase", "m_flLastCritCheckTime");
        this->bPlayerDominated              = gNetvars.get_offset("DT_TFPlayer", "m_Shared", "m_bPlayerDominated");
        ...
        this->m_iCritMult   = gNetvars.get_offset("DT_TFPlayer", "m_Shared", "m_iCritMult");
        this->m_iRoundState = gNetvars.get_offset("DT_TeamplayRoundBasedRules", "m_iRoundState");
        this->m_iWinningTeam = gNetvars.get_offset("DT_TeamplayRoundBasedRules", "m_iWinningTeam");
        this->m_bPlayingMannVsMachine = gNetvars.get_offset("DT_TFGameRules", "m_bPlayingMannVsMachine");
        this->m_halloweenScenario     = gNetvars.get_offset("DT_TFGameRules", "m_halloweenScenario");
        this->m_bIsUsingSpells        = gNetvars.get_offset("DT_TFGameRules", "m_bIsUsingSpells");
    }
    IF_GAME(IsTF2C())
    {
    ...
    this->m_nCurrency           = gNetvars.get_offset("DT_TFPlayer", "m_nCurrency");
    this->m_bUsingActionSlot    = gNetvars.get_offset("DT_TFPlayer", "m_bUsingActionSlot");
    this->m_hConstraintEntity   = gNetvars.get_offset("DT_BasePlayer", "m_hConstraintEntity");
    this->m_pCurrentCommand     = (this->m_hConstraintEntity > 8) ? this->m_hConstraintEntity - 8 : 5664;
    this->m_rgflCoordinateFrame = 0;
}
