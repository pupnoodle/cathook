...
bool doMovedSwingTrace(CachedEntity *target, Vector new_target_origin)
{
    ...
    static auto sig_mark                                              = gSignatures.GetClientSignature(sigs::mark_surrounding_bounds_dirty);
    static MarkSurroundingBoundsDirty_t MarkSurroundingBoundsDirty_fn = sig_mark ? (MarkSurroundingBoundsDirty_t) sig_mark : nullptr;
