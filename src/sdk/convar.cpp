...
//-----------------------------------------------------------------------------
void ConVar::Create(const char *pName, const char *pDefaultValue, int flags /*= 0*/, const char *pHelpString /*= NULL*/, bool bMin /*= false*/, float fMin /*= 0.0*/, bool bMax /*= false*/, float fMax /*= false*/, bool /*bCompMin*/, float /*fCompMin*/, bool /*bCompMax*/, float /*fCompMax*/, FnChangeCallback_t callback /*= NULL*/)
{
    m_pParent = this;
