...
steam_root="${1:-/opt/pupbot-shared-steam}"
install_root="${2:-/opt/puphook/botpanel/pup-steamtxtmode}"
...
if 'PUP_STEAM_TXTMODE_PRELOAD' not in text:
...
for arch in 32 64; do
    ...
    for binary in libpupsteamtxtmode.so pupsteamtxtmode; do
