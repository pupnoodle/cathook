...
PUP_STM_EXPORT int execv(const char* path, char* const argv[])
{
...
PUP_STM_EXPORT int execvp(const char* file, char* const argv[])
{
  static int (*real)(const char*, char* const[]) = nullptr;
  if (real == nullptr)
  {
...
PUP_STM_EXPORT int execve(const char* path, char* const argv[], char* const envp[])
{
...
PUP_STM_EXPORT int posix_spawn(pid_t* pid, const char* path,
