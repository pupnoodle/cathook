...
public:
    ...
    static void mprotectAddr(uintptr_t addr, int size, int flags)
    {
        void *page          = (void *) (addr & ~0xFFFull);
        void *end_page      = (void *) ((addr + size) & ~0xFFFull);
        uintptr_t mprot_len = (uintptr_t) end_page - (uintptr_t) page + 0xFFF;
